...
class Fixtures {
  ...
  // Models
  static TaskModel get task1Model => const TaskModel(
        id: 'task_1',
        title: 'Test Task 1',
        type: 'listen_repeat',
        estimatedSeconds: 60,
  ...
  static TaskModel get task2Model => const TaskModel(
        id: 'task_2',
        title: 'Test Task 2',
        type: 'multiple_choice',
        estimatedSeconds: 90,
  ...
  static TaskModel get task3Model => const TaskModel(
        id: 'task_3',
        title: 'Test Task 3',
        type: 'fill_in_the_blanks',
        estimatedSeconds: 120,
  ...
  static LessonModel get completedLessonModel => LessonModel(
        id: 'lesson_1',
        title: 'Test Lesson 1',
        position: 1,
        status: LessonStatus.completed,
        xp: 20,
        estimatedMinutes: 5,
        tasks: [task1Model, task2Model],
      );

  static LessonModel get currentLessonModel => LessonModel(
        id: 'lesson_2',
        title: 'Test Lesson 2',
        position: 2,
        status: LessonStatus.current,
        xp: 25,
        estimatedMinutes: 6,
        tasks: [task1Model, task2Model, task3Model],
      );

  static LessonModel get lockedLessonModel => LessonModel(
        id: 'lesson_3',
        title: 'Test Lesson 3',
        position: 3,
        status: LessonStatus.locked,
  ...
  static LearningPathModel get learningPathModel => LearningPathModel(
        id: 'path_1',
        name: 'Test Path',
        description: 'Test Description',
        lessons: [completedLessonModel, currentLessonModel, lockedLessonModel],
      );
}
